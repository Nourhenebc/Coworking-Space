...
Equipement::Equipement(int ref,QString modele,QString etat,QString date,int prix,QString img){
...
bool Equipement :: ajouter(){
    ...
    query.prepare("INSERT INTO ETUDIANT (REF, MODELE, ETAT,DATE1,PRIX,img) "
                  "VALUES (:ref, :modele, :etat,  :date,  :prix, :img)");
