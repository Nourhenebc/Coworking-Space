...
Equipement E(ref ,modele,etat,date_de_naissance,prix,imgx);
bool test=E.ajouter();
...
void MainWindow::on_pb_pdf_clicked()
{
        ...
        QPdfWriter pdf("C:/Users/Nourhene/Desktop/equi/nnnn/testpdf.pdf");
...
void MainWindow::on_insert_img_clicked()
{
...
void MainWindow::on_tab_etudiant_clicked(const QModelIndex &index)
{
...
void MainWindow::on_close_5_clicked()
{
    close();

}

void MainWindow::on_red_slider_4_sliderMoved(int position)
{
    ui->red_value_label_4->setText(QString("<span style=\" font-size:18pt; font-weight:600;\">%1</span>").arg(position));
       MainWindow::updateRGB(QString("r%1").arg(position));
        qDebug() << position;
}
...
void MainWindow::on_green_slider_4_sliderMoved(int position)
{
    ui->green_value_label_4->setText(QString("<span style=\" font-size:18pt; font-weight:600;\">%1</span>").arg(position));
        MainWindow::updateRGB(QString("g%1").arg(position));
        qDebug() << position;
}

void MainWindow::on_blue_slider_4_sliderMoved(int position)
{
    ui->blue_value_label_4->setText(QString("<span style=\" font-size:18pt; font-weight:600;\">%1</span>").arg(position));
       MainWindow::updateRGB(QString("b%1").arg(position));
       qDebug() << position;
}
